...
public class TempletAlbumMain {
	...
	private TempletSubElement elPublic;
	private TempletSubElement elIndex;
	private TempletSubElement elNav;
	private TempletSubElement elArt;
	private TempletSubElement elCorpus;
//	private TempletPortalSubElement elSearch;
	private TempletSubElement elEdit;
	private TempletSubElement elExtend;
	...
	public TempletSubElement getElPublic() {
		return elPublic;
	}
	public void setElPublic(TempletSubElement elPublic) {
		this.elPublic = elPublic;
	}
	public TempletSubElement getElIndex() {
		return elIndex;
	}
	public void setElIndex(TempletSubElement elIndex) {
		this.elIndex = elIndex;
	}
	public TempletSubElement getElNav() {
		return elNav;
	}
	public void setElNav(TempletSubElement elNav) {
		this.elNav = elNav;
	}
	public TempletSubElement getElArt() {
		return elArt;
	}
	public void setElArt(TempletSubElement elArt) {
		this.elArt = elArt;
	}
	public TempletSubElement getElCorpus() {
		return elCorpus;
	}
	public void setElCorpus(TempletSubElement elCorpus) {
...
//	}
	public TempletSubElement getElExtend() {
		return elExtend;
	}
	public void setElExtend(TempletSubElement elExtend) {
		this.elExtend = elExtend;
	}
	public TempletSubElement getElEdit() {
		return elEdit;
	}
	public void setElEdit(TempletSubElement elEdit) {
		this.elEdit = elEdit;
	}
