...
<colgroup>
  ...
  <tr>
		...
		<th class="col_center"  align="center">专用模板</th>
...
<c:if test="${g.id > 0 }">
<td ><a href="${pageContext.request.contextPath}/show_portal/nav/${g.id}" target="_blank">${g.title} </a></td>
...
<td class="col_center"><c:if test="${g.templet != null }">有</c:if></td>
