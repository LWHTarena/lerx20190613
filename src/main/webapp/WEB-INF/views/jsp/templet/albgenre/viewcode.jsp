...
<form class="layui-form" method="post" action="${pageContext.request.contextPath}/action_albgenre_templet/modifyCode/${requestScope.templetID }/${requestScope.area }/${requestScope.var}">
<div class="layui-form-item">
