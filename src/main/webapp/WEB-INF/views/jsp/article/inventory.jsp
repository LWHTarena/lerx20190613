...
<td class="col_title_left" ><a target="_blank" href="${pageContext.request.contextPath}/show_portal/art/${art.id}">${art.subject}</a></td> 
<td ><a target="_blank" href="${pageContext.request.contextPath}/show_portal/nav/${art.agroup.id}">${art.agroup.name}/ (${art.agroup.id})</a> </td>
