    ...
    <div class="login_box">
	   	  ...
	   	  <div class="login_box_main">
	   	    ...
	   	    <c:if test="${sessionScope.vcode_admin_lerx eq 'true'}">
	   	     <p class="login_box_main_mobile">
                    <input name="vcode" type="text" id="vcode" maxlength='<spring:message code="vcode.sendchar.length"></spring:message>' placeholder="验证码" class="vcode" autocomplete="off" onfocus="showVcode()" />  <img class="vimg" src="" width="88" height="30" name="validCodeImg" id="validCodeImg"
