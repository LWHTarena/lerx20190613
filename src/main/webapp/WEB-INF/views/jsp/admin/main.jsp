      ...
      <ul class="layui-nav layui-nav-tree" lay-shrink="all"  lay-filter="layadmin-system-side-menu">
        ...
        <li class="layui-nav-item" data-jump data-name="user">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a target="myframe" href="${pageContext.request.contextPath}/action_static/start">　<i class="layui-icon">&#xe623;</i> 文章重新静态化</a></dd>
          </dl>
        </li>
		<!--
        <li class="layui-nav-item" data-jump data-name="user">
          ...
          <dl class="layui-nav-child">
            <dd><a target="myframe" href="${pageContext.request.contextPath}/action_albgenre/list">　<i class="layui-icon">&#xe623;</i> 类型管理</a></dd>
          </dl>
        </li>
		-->
        <li class="layui-nav-item" data-jump data-name="user">
          ...
          <dl class="layui-nav-child">
            <dd><a target="myframe" href="${pageContext.request.contextPath}/action_portal_templet/list">　<i class="layui-icon">&#xe623;</i> 网站门户模板列表</a></dd>
			<!--
            <dd><a target="myframe" href="${pageContext.request.contextPath}/action_albgenre_templet/list">　<i class="layui-icon">&#xe623;</i> 专辑频道模板列表</a></dd>
            <dd><a target="myframe" href="${pageContext.request.contextPath}/action_album_templet/list">　<i class="layui-icon">&#xe623;</i> 专辑模板列表</a></dd>
			-->
          </dl>
        </li>
        <li class="layui-nav-item" data-jump data-name="user">
